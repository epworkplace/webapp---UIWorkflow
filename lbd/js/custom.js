$(document).ready(function(){
  ...
  //Floating Module
	...
	//Custom Scrollbar
	$(".floating-box-body .panel #panel-body, .month-values-panel, .reviews, .recommended-reviews, .leftside-column, .rightside-column, .feeds-comments-container").mCustomScrollbar({
