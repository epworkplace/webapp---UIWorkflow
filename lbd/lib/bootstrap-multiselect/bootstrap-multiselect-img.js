    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><div class="input-group input-prepend input-append"><span class="add-on"><i class="splashy-zoom"></i></span><input class="form-control multiselect-search span12" type="text"></div></li>',
                filterClearBtn: '<span class="add-on"><i class="splashy-error_x"></i></span>',
        ...
        buildButton: function() {
			...
			this.$button.attr('id',this.$select.attr('id')+'_chzn');
        ...
        createOptionValue: function(element) {
			...
			var label = this.options.labelImg(element)+this.options.label(element);
			...
			$checkbox.attr('data-toggle', 'checkbox');
