$(document).ready(function() {
    ...
    $("#filer_input2").filer({
        limit: null,
        maxSize: null,
        extensions:null,//["doc","xls","zip","docx","xlsx","rar","pdf","dot","jpg","png","xml"],
        ...
        files: "{/literal}{$send_quote.documents_files}{literal}",
        addMore: true,
        clipBoardPaste: true,
        excludeName: null,
        beforeRender: null,
       ...
       /*  onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
        ...
        captions: {
            ...
            errors: {
                ...
                filesType: "Only doc,xls,zip,docx,xlsx,dot,pdf,png,jpg \n xml,rar are allowed to be uploaded.",
