				...
				f = {
					...
					_filesCheck: function() {
						...
						if(n.limit && f.files.length + f._itFl.length > n.limit) {
							swal("",f._assets.textParse(n.captions.errors.filesLimit));
							return false
						}
						for(var t = 0; t < f.files.length; t++) {
							...
							if(n.extensions != null && $.inArray(x, n.extensions) == -1) {
								swal("",f._assets.textParse(n.captions.errors.filesType, m));
								return false;
								break
							}
							if(n.maxSize != null && f.files[t].size > n.maxSize * 1048576) {
								swal("",f._assets.textParse(n.captions.errors.filesSize, m));
								return false;
								break
							}
						...
						if(n.maxSize != null && s >= Math.round(n.maxSize * 1048576)) {
							swal("",f._assets.textParse(n.captions.errors.filesSizeAll));
							return false
						}
					...
					_assets: {
						...
						text2Color: function(str) {
							...
							for(var i = 0, colour = "#"; i < 3; colour += ("00" + ((hash >> i++ * 2) & 0x9A8)
									.toString(16))
								.slice(-2));
							return colour;
						}
